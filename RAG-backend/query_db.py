#!/usr/bin/env python3
"""
Command-line interface to query the Qdrant vector database
Usage: python query_db.py --query "your query here"
"""
...
def main():
    parser = argparse.ArgumentParser(description='Query the Qdrant vector database')
    ...
    print("="*70)
    print("QDRANT VECTOR DATABASE QUERY INTERFACE")
    print("="*70)
